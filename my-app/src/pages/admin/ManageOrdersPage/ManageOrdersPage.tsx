  ...
  return (
      ...
      >
        ...
        <div className="p-4">
          ...
          <p className="text-sm text-slate-600 mb-2">{formatCurrency(invoice.realAmount ?? invoice.totalAmount)}</p>
                    ...
                    <div className="space-y-4 animate-fade-in">
                      ...
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        <div>
                          ...
                          <p className="font-semibold text-slate-800">{formatCurrency(selectedInvoice.totalAmount)}</p>
                        </div>
                        <div>
                          <p className="text-slate-500">Paid</p>
                          <p className="font-semibold text-emerald-600">{formatCurrency(selectedInvoice.realAmount)}</p>
                        </div>
                        <div>
